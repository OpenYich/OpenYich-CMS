...
import com.openyich.framework.cloud.cms.mapper.ISysDeptMapper;
import com.openyich.framework.cloud.cms.repository.SysDeptRepository;

@Component
public class SysDeptMapperImpl extends JpaQueryMapperImpl<SysDept> implements ISysDeptMapper {
