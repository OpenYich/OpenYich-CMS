...
import com.openyich.framework.cloud.cms.mapper.ISysMenuMapper;
import com.openyich.framework.cloud.cms.repository.SysMenuRepository;

@Component
public class SysMenuMapperImpl extends JpaQueryMapperImpl<SysMenu> implements ISysMenuMapper {
